...
import { User, Loader2, AlertCircle, MessageCircle, Lock, Eye, EyeOff } from 'lucide-react'
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          ...
          <p className="text-white/40 text-sm mb-6">
            Enter your portal username and password to access your character.
          </p>
          ...
          <form onSubmit={e => { e.preventDefault(); handleSubmit(); }} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="relative">
                <User className="w-4 h-4 absolute left-3.5 top-1/2 -translate-y-1/2 text-white/30 pointer-events-none" />
                <input
                  type="text"
              ...
              <p className="text-[11px] text-white/25 mt-1.5">
                Set your username in WhatsApp with <span className="text-white/45 font-mono">!portal</span>
              </p>
            </div>
          ...
          <div className="mt-6 pt-5 border-t border-white/8 flex items-start gap-3 text-sm text-white/40">
            ...
            <p>
              No portal account yet? Open WhatsApp, message the bot, and type{' '}
              <span className="text-white/60 font-mono">!register</span> to create your character, then{' '}
              <span className="text-white/60 font-mono">!portal</span> to set your web login.
            </p>
          </div>
        </div>
      </div>
