...
import { Home, CreditCard, Layers, Store, Menu, X, User, LogOut, Settings, Crown, Coins, Gem, ChevronRight, Package, Star } from "lucide-react";
...
const NAV_LINKS = [
  ...
  { href: "/seasonpass", label: "Season Pass", icon: Star },
];
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 p-4 border-b border-white/6">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-[11px] text-white/40 truncate font-mono">{user.username}</div>
                    ...
                    <div className="flex divide-x divide-white/5 border-b border-white/6">
                      <div className="flex-1 flex flex-col items-center py-3">
                        <div className="flex items-center gap-1 text-amber-400 mb-0.5">
                          ...
                          <span className="text-[11px] font-bold">{user.gold >= 1000 ? `${(user.gold / 1000).toFixed(1)}K` : user.gold}</span>
                        </div>
                      ...
                      <div className="flex-1 flex flex-col items-center py-3">
                        <div className="flex items-center gap-1 text-purple-400 mb-0.5">
                          ...
                          <span className="text-[11px] font-bold">{user.gems}</span>
                        </div>
                      ...
                      <div className="flex-1 flex flex-col items-center py-3">
                        <div className="flex items-center gap-1 text-[#4ecdc4] mb-0.5">
                          <span className="text-[11px] font-bold">{user.dungeonFloor}</span>
                        </div>
                    ...
                    <div className="p-1.5">
                      {[
                        ...
                        { href: "/inventory", icon: Package, label: "My Inventory" },
                        { href: "/seasonpass", icon: Star, label: "Season Pass" },
                        { href: "/topup", icon: Crown, label: "Buy Gems" },
                      ].map((item) => {
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="flex gap-3 mt-1">
                  ...
                  <span className="text-xs text-purple-400">💎 {user.gems}</span>
                </div>
              </div>
